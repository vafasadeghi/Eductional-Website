...
@section('content')
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
       ...
       <div class="page-header head-section">
        ...
        <form  class="form-horizontal" action="{{route('courses.update',['course'=>$course->id])}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="title" id="title" placeholder="لطفا عنوان را وارد کنید" value="{{ $course->title }}" >
            </div>
            </div>
