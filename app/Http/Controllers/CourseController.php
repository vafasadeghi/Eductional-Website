...
{
    protected $MerchantID = '86d270f5-1c73-4477-8170-36f52f91285f'; //Required
...
//        Redis::incr("views.{$course->id}.courses");
    ...
    {
        $hash = 'askyjhdjh!@@#fldlkf$%^dlfkl15f' . $episode->id . \request()->ip() . \request('t');
        ...
        {
            return 'لینک دانلود از کار افتاده است';
        }
    }
