...
@section('content')
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <form  class="form-horizontal" action="{{route('episodes.update',['episode'=> $episode->id])}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    ...
                    <input type="text" class="form-control" name="title" id="title" placeholder="لطفا عنوان را وارد کنید" value="{{ $episode->title }}" >
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-12">
            ...
            <div class="form-group">
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control" name="time" id="time" placeholder="زمان ویدیو  را وارد کنید" value="{{ $episode->time }}" >
                </div>
                <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">$episode->description
