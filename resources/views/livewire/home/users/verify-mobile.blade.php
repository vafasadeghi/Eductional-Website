<div>
    @section('styles')
    <script src="{{ asset('home/js/alpin.min.js') }}"></script>
    @endsection
    @section('title','تایید مبایل')
    <div id="main">
            ...
            <div class="account-box">
                ...
                <div class="message-light">
                    <div class="massege-light">
                        برای شماره همراه <b>{{ $user->phone }}</b>کد تایید ارسال گردید
                        <br>
                    ...
                    <div class="parent-btn">
                        <button style="text-align: center" class="dk-btn dk-btn-info" type="submit">
                            ثبت
