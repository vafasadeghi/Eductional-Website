       ...
       <div class="page-header head-section">
        ...
        <form  class="form-horizontal" action="{{route('articles.update',['article'=>$article->id])}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="title" id="title" placeholder="لطفا عنوان را وارد کنید" value="{{ $article->title }}" >
            </div>
            </div>
            <div class="form-group">
                <div class="col-sm-12">
                <label for="title" class="control-label"> توضیح کوتاه </label>
                    <textarea rows="5" class="form-control" name="description" id="description" placeholder="لطفا توضیح کوتاه را وارد کنید" >{{ $article->description }}</textarea>
            </div>
            </div>
            <div class="form-group">
                <div class="col-sm-12">
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    ...
                    <input type="file" class="form-control" name="images" id="images" placeholder="تصویر اصلی  را وارد کنید"  >
                </div>
                    <div class="col-sm-12">
                        <div class="row">
